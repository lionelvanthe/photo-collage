...
class Recorder(
    ...
    companion object {
        ...
        private const val DEFAULT_BITRATE = 2 * 1000 * 1000
    ...
    private fun drainEncoderPostLollipop(endOfStream: Boolean) {
        Log.d("Thenv", "drainEncoderPostLollipop: vo day thoi")
        encodeLoop@ while (true) {
            ...
            when {
                ...
                outputBufferIndex == MediaCodec.INFO_OUTPUT_FORMAT_CHANGED -> {
                    Log.d("Thenv", "drainEncoderPostLollipop: vo day 1")
                    startMuxer()
                }

                outputBufferIndex > 0 -> {
                    Log.d("Thenv", "drainEncoderPostLollipop: vo day 2")
                    if (encodeVideoData(
